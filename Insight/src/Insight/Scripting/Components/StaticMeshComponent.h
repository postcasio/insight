...
{
    struct ScriptStaticMeshComponent
    {
        ...
        static ScriptStaticMeshComponent* FromObject(JSObject* obj)
        {
            return reinterpret_cast<ScriptStaticMeshComponent*>(obj);
        }

        static JSObject* AsObject(ScriptStaticMeshComponent* custom)
        {
